...
RSpec.describe LedgerSync::NetSuite::Check::SearcherDeserializer do
  ...
  describe '#deserialize' do
    ...
    let(:deserialized_resource) { serializer.deserialize(hash: h, resource: LedgerSync::NetSuite::Check.new) }
