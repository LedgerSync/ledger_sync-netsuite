...
RSpec.describe LedgerSync::NetSuite::AdvancedIntercompanyJournalEntry, qa: true, client: :netsuite do
  ...
  let(:resource) do
    LedgerSync::NetSuite::AdvancedIntercompanyJournalEntry.new(
      memo: 'Hello World',
      trandate: Date.today.to_s,
      currency: known_currency,
      external_id: "journal_entry_test_#{test_run_id}",
      line_items: [
        LedgerSync::NetSuite::AdvancedIntercompanyJournalEntryLineItem.new(
          credit: 12.20,
